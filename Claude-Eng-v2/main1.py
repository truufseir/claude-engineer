...
class APIKeyManager:
    def __init__(self, master):
        ...
        # API Key Management GUI setup (in self.api_tab)
        self.setup_api_tab()

        # Password Generator GUI setup (in self.password_tab)
        self.setup_password_tab()

    def setup_api_tab(self):
        # GUI setup for API Key Management
        ...
        self.label_key.grid(row=1, column=0, padx=10, pady=10, sticky=tk.W)
        ...
        self.button_add.grid(row=2, column=0, padx=10, pady=10, sticky=tk.W)

        self.button_view = ttk.Button(self.api_tab, text="View Keys", command=self.show_password_prompt)
        self.button_view.grid(row=2, column=1, padx=10, pady=10)

        self.button_scramble = ttk.Button(self.api_tab, text="Scramble", command=None)
        self.button_scramble.grid(row=2, column=2, padx=10, pady=10)
        ...
        self.button_delete.grid(row=4, column=0, columnspan=3, padx=10, pady=10)

        # GUI elements for interacting with Ollama
        self.prompt_label = ttk.Label(self.api_tab, text="Enter Prompt:")
        self.prompt_label.grid(row=5, column=0, padx=10, pady=10, sticky=tk.W)

        self.prompt_entry = ttk.Entry(self.api_tab, width=50)
        self.prompt_entry.grid(row=5, column=1, padx=10, pady=10)

        self.send_button = ttk.Button(self.api_tab, text="Send to Ollama", command=self.send_to_ollama)
        self.send_button.grid(row=5, column=2, padx=10, pady=10)

        self.response_label = ttk.Label(self.api_tab, text="Response:")
        self.response_label.grid(row=6, column=0, padx=10, pady=10, sticky=tk.W)

        self.response_text = tk.Text(self.api_tab, wrap=tk.WORD)
        self.response_text.grid(row=6, column=1, columnspan=2, padx=10, pady=10)
        ...
        self.status_label.grid(row=7, column=0, columnspan=3, sticky="ew", padx=10)

    def setup_password_tab(self):
        # Password Generator GUI setup
        ...
        ttk.Label(self.password_frame, text='Username:').grid(row=1, column=0, padx=5, pady=5, sticky='e')
        self.username_entry = ttk.Entry(self.password_frame)
        self.username_entry.grid(row=1, column=1, padx=5, pady=5)

        ttk.Label(self.password_frame, text='Site:').grid(row=2, column=0, padx=5, pady=5, sticky='e')
        self.site_entry = ttk.Entry(self.password_frame)
        self.site_entry.grid(row=2, column=1, padx=5, pady=5)
        ...
        ttk.Label(self.password_frame, text='Generated Password:').grid(row=4, column=0, padx=5, pady=5, sticky='e')
        self.password_label = ttk.Label(self.password_frame, text='')
        self.password_label.grid(row=4, column=1, padx=5, pady=5, sticky='w')
